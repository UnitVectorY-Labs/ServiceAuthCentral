...
public interface AuthorizationJpaRepository extends JpaRepository<AuthorizationEntity, String> {
    ...
    Optional<AuthorizationEntity> findBySubjectAndAudience(String subject, String audience);

    List<AuthorizationEntity> findBySubject(String subject);

    List<AuthorizationEntity> findByAudience(String audience);
}
