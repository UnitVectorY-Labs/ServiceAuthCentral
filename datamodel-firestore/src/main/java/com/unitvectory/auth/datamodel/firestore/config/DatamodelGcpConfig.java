 ...
 * the License.
 */
package com.unitvectory.auth.datamodel.firestore.config;
...
import com.unitvectory.auth.datamodel.firestore.repository.FirestoreAuthorizationRepository;
import com.unitvectory.auth.datamodel.firestore.repository.FirestoreClientRepository;
import com.unitvectory.auth.datamodel.firestore.repository.FirestoreJwkCacheRepository;
import com.unitvectory.auth.datamodel.firestore.repository.FirestoreLoginCodeRepository;
import com.unitvectory.auth.datamodel.firestore.repository.FirestoreLoginStateRepository;
