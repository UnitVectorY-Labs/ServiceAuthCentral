...
| ---------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SPRING_PROFILES_ACTIVE | Yes      | A corresponding profile must be selected for each of [Data Store]({{ site.baseurl }}{% link datastore/datastore.md %}) and [Sign]({{ site.baseurl }}{% link sign/sign.md %}). These are set as a comma separated list. |
